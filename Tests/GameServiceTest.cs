using VerticalSliceArchitecture.Games.Features.Services;
using VerticalSliceArchitecture.Games.Models;
...
public class GameServiceTest
{
    ...
    public async Task WhenGameIsAdded_GameCreatedSuccessfully()
    {
        ...
        //When
        new GameService(_context).AddGameToConsole(1,
            new Game { Id = 10, Name = "Fighting Simulator", Publisher = "Best Fights Corp" });
    ...
    public async Task WhenGetGameByID_ThenSpecifiedGameIsReturnedSuccessfully()
    {
        ...
        new GameService(_context).AddGameToConsole(1,
            new Game { Id = 12, Name = "Running Simulator", Publisher = "Best Runs Corp" });

        await _context.SaveChangesAsync();

        //When
        Game game = await new GameService(_context).GetGameAsync(1, 12);
    ...
    public async Task WhenDeletingAGame_ThenSpecifiedGameIsDeletedSuccessfully()
    {
        ...
        Game? deletedGame = await _context.Games.FirstOrDefaultAsync(x => x.Id == 13);
